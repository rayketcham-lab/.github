...
- **Portfolio consolidation** — tailnumber, parcl, qn-claude-web, and shadowtrap are retired; effort is narrowing onto the PKI tooling and Quantum Nexum
- **PKI-Client and PKI-Signing-Service under rework** — post-quantum signing moves from an opt-in build feature to first-class support in both
...
Open code, with each project's real state on the label.  Release, CI, and license badges read straight from the repository, so they never go stale — and anything under rework or retired says so plainly rather than leaving you to find out.

### 🔐 PKI & Post-Quantum Crypto

| Project | What it does | Status |
|---------|--------------|--------|
| **[PKI-Client](https://github.com/rayketcham-lab/PKI-Client)** · [docs](https://rayketcham-lab.github.io/PKI-Client/) | Pure-Rust PKI CLI — inspect certificates, generate keys, probe TLS, validate FIPS 140-3 / NIST SP 800-57 / Federal Bridge compliance, and build CA hierarchies.  No OpenSSL; one static musl binary.  **⚠️ Under rework pending post-quantum changes** — ML-DSA and SLH-DSA move from the opt-in `--features pqc` path to first-class support.  Existing releases still install. | [![release](https://img.shields.io/github/v/release/rayketcham-lab/PKI-Client?label=release&color=2ea44f)](https://github.com/rayketcham-lab/PKI-Client/releases) [![status](https://img.shields.io/badge/status-rework-orange)](https://github.com/rayketcham-lab/PKI-Client) [![PQC](https://img.shields.io/badge/PQC-changes_pending-8957e5)](https://github.com/rayketcham-lab/PKI-Client) [![license](https://img.shields.io/github/license/rayketcham-lab/PKI-Client?color=blue)](https://github.com/rayketcham-lab/PKI-Client/blob/main/LICENSE) |
| **[PKI-Signing-Service](https://github.com/rayketcham-lab/PKI-Signing-Service)** · [docs](https://rayketcham-lab.github.io/PKI-Signing-Service/) | Pure-Rust code-signing engine — Authenticode (PE/CAB/MSI), PKCS#7/CMS, RFC 3161 timestamping, PowerShell SIP, detached CMS.  Runs as CLI, REST API, or a standalone TSA server; batch signing and PFX import.  **⚠️ Under rework pending post-quantum changes** — ML-DSA graduates from `--features pq-experimental`.  Existing releases still install. | [![release](https://img.shields.io/github/v/release/rayketcham-lab/PKI-Signing-Service?label=release&color=2ea44f)](https://github.com/rayketcham-lab/PKI-Signing-Service/releases) [![status](https://img.shields.io/badge/status-rework-orange)](https://github.com/rayketcham-lab/PKI-Signing-Service) [![PQC](https://img.shields.io/badge/PQC-changes_pending-8957e5)](https://github.com/rayketcham-lab/PKI-Signing-Service) [![CI](https://img.shields.io/github/actions/workflow/status/rayketcham-lab/PKI-Signing-Service/ci.yml?branch=main&label=CI)](https://github.com/rayketcham-lab/PKI-Signing-Service/actions) [![license](https://img.shields.io/github/license/rayketcham-lab/PKI-Signing-Service?color=blue)](https://github.com/rayketcham-lab/PKI-Signing-Service/blob/main/LICENSE) |
...
No longer in service.  Listed for provenance — and, where the writeup outlived the product, because the thinking is still worth reading.  None of these are receiving fixes; don't build on them.

| Project | What it did | Status |
|---------|-------------|--------|
| **[tailnumber](https://github.com/rayketcham-lab/tailnumber)** | Detached Hash-Signing as a Service (dHSaaS) — send a hash, get back a portable signed proof.  ML-DSA and hybrid classical+PQ signatures, HSM-held non-extractable keys, 50-year trust chain, offline verification with nothing but OpenSSL.  The [design writeup](https://github.com/rayketcham-lab/tailnumber) stays public — key rotation, generational CAs, and why rotation alone doesn't keep a decades-old signature verifiable. | [![status](https://img.shields.io/badge/status-retired-6e7781)](https://github.com/rayketcham-lab/tailnumber) [![writeup](https://img.shields.io/badge/writeup-public-3DDC97)](https://github.com/rayketcham-lab/tailnumber) [![source](https://img.shields.io/badge/source-private-lightgrey)](https://github.com/rayketcham-lab/tailnumber) |
| **[parcl](https://github.com/rayketcham-lab/parcl)** | S/MIME encryption, signing, and certificate management add-in for Microsoft Outlook — LDAP directory lookup, AES-256, RFC 5751/7508 compliant.  Releases were pulled; the add-in is not installable. | [![status](https://img.shields.io/badge/status-retired-6e7781)](https://github.com/rayketcham-lab/parcl) [![license](https://img.shields.io/github/license/rayketcham-lab/parcl?color=blue)](https://github.com/rayketcham-lab/parcl/blob/main/LICENSE) |
| **[qn-claude-web](https://github.com/rayketcham-lab/qn-claude-web)** | Self-hosted web UI for the Claude Code CLI — xterm.js terminal, persistent tmux sessions, chat, and multi-agent orchestration from any browser on your network.  Pure Python, no build step. | [![status](https://img.shields.io/badge/status-retired-6e7781)](https://github.com/rayketcham-lab/qn-claude-web) [![license](https://img.shields.io/github/license/rayketcham-lab/qn-claude-web?color=blue)](https://github.com/rayketcham-lab/qn-claude-web/blob/main/LICENSE) |
| **shadowtrap** | Multi-protocol network honeypot — 21 emulated services, honeytokens that fire on access, full payload capture with GeoIP and threat scoring, real-time HTTPS dashboard. | [![status](https://img.shields.io/badge/status-retired-6e7781)](https://github.com/rayketcham-lab) [![source](https://img.shields.io/badge/source-private-lightgrey)](https://github.com/rayketcham-lab) |

> Licensing varies by project — each badge above reflects that repository's own `LICENSE`.  Most tooling is Apache-2.0; project-forge is MIT; tailnumber and shadowtrap are closed-source.  gh-tracker isn't licensed for reuse yet, and its badge says so.
