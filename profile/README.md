...
| **[project-forge](https://github.com/rayketcham-lab/project-forge)** | Autonomous idea-generation engine &mdash; scores every idea on feasibility, fundability, and ambition across 19 categories, then human-gates one-click promotion to GitHub issues. FastAPI + SQLite; ~$2&ndash;3/mo on Haiku 4.5 (or free via the Claude Code CLI). | [![status](https://img.shields.io/badge/status-in_development-yellow)](https://github.com/rayketcham-lab/project-forge) [![license](https://img.shields.io/github/license/rayketcham-lab/project-forge?color=lightgrey)](https://github.com/rayketcham-lab/project-forge) |
